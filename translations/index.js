const translations = {
  en: {
    ...
    nearbyMasjidsFound: '🕌 *Nearby Masjids Found*\n\nFound {count} masjid(s) within 3km radius:',
    noMasjidsFound: '🕌 *No Masjids Found*\n\nNo masjids found within 3km radius. Try expanding your search area or check if you\'re in a location with masjids nearby.',
    ...
    apiNotConfigured: '❌ *Service Unavailable*\n\nGoogle Places API is not configured. Please contact support for assistance.',
    apiError: '❌ *API Error*\n\nError accessing Google Places API. Please try again later.',
  ...
  am: {
    ...
    nearbyMasjidsFound: '🕌 *ቅርብ መስጂዶች ተገኝተዋል*\n\nበ3ኪሎ ሜትር ክልል ውስጥ {count} መስጂድ(ዎች) ተገኝተዋል:',
    noMasjidsFound: '🕌 *ምንም መስጂዶች አልተገኙም*\n\nበ3ኪሎ ሜትር ክልል ውስጥ ምንም መስጂዶች አልተገኙም። የፍለጋ ክልልዎን ለማስፋት ይሞክሩ ወይም በአካባቢዎ መስጂዶች እንዳሉ ያረጋግጡ።',
    ...
    apiNotConfigured: '❌ *አገልግሎት አይገኝም*\n\nGoogle Places API አልተቋቋመም። እባክዎ ለእገዛ ድጋፍ ያግኙ።',
    apiError: '❌ *API ስህተት*\n\nGoogle Places API በመድረስ ላይ ስህተት። እባክዎ ቆይተው እንደገና ይሞክሩ።',
  ...
  ar: {
    ...
    nearbyMasjidsFound: '🕌 *تم العثور على مساجد قريبة*\n\nتم العثور على {count} مسجد(ات) في نطاق 3 كيلومتر:',
    noMasjidsFound: '🕌 *لم يتم العثور على مساجد*\n\nلم يتم العثور على مساجد في نطاق 3 كيلومتر. حاول توسيع منطقة البحث أو تحقق من وجود مساجد في منطقتك.',
    ...
    apiNotConfigured: '❌ *الخدمة غير متاحة*\n\nGoogle Places API غير مُكوَّن. يرجى الاتصال بالدعم للمساعدة.',
    apiError: '❌ *خطأ في API*\n\nخطأ في الوصول إلى Google Places API. يرجى المحاولة مرة أخرى لاحقاً.',
