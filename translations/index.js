const translations = {
  en: {
    ...
    nearbyMasjidsFound: '🕌 *Nearby Masjids Found*\n\nClick on any option below to view masjids in Google Maps:',
    top5Masjids: '📍 *Top 5 Nearby Masjids*',
    masjid1: '🕌 Masjid 1',
    masjid2: '🕌 Masjid 2',
    masjid3: '🕌 Masjid 3',
    masjid4: '🕌 Masjid 4',
  ...
  am: {
    ...
    nearbyMasjidsFound: '🕌 *ቅርብ መስጂዶች ተገኝተዋል*\n\nበGoogle Maps ውስጥ መስጂዶችን ለማየት ከዚህ በታች ያለውን አማራጭ ይንኩ:',
    top5Masjids: '📍 *ቀዳሚ 5 ቅርብ መስጂዶች*',
    masjid1: '🕌 መስጂድ 1',
    masjid2: '🕌 መስጂድ 2',
    masjid3: '🕌 መስጂድ 3',
    masjid4: '🕌 መስጂድ 4',
  ...
  ar: {
    ...
    nearbyMasjidsFound: '🕌 *تم العثور على مساجد قريبة*\n\nانقر على أي خيار أدناه لعرض المساجد في خرائط جوجل:',
    top5Masjids: '📍 *أفضل 5 مساجد قريبة*',
    masjid1: '🕌 مسجد 1',
    masjid2: '🕌 مسجد 2',
    masjid3: '🕌 مسجد 3',
    masjid4: '🕌 مسجد 4',
