const translations = {
  en: {
    ...
    btnQuranScheduler: '📖 Quran Scheduler',
    quranSchedulerPrompt: '📖 *Quran Recitation Scheduler*\n\nPlease enter the page range you want to recite.\n\n*Format:* Start-End (e.g., 1-10) or Start End (e.g., 1 10)\n\n*Example:*\n• 1-10 (pages 1 to 10)\n• 50 100 (pages 50 to 100)\n• 1-604 (complete Quran)',
    quranInvalidPageFormat: '❌ *Invalid Format*\n\nPlease enter the page range in one of these formats:\n• 1-10\n• 1 10\n• 1,10\n\n*Note:* Pages must be between 1 and 604.',
    quranInvalidStartPage: '❌ *Invalid Start Page*\n\nStart page must be between 1 and 604.',
    quranInvalidEndPage: '❌ *Invalid End Page*\n\nEnd page must be between 1 and 604.',
    quranStartGreaterThanEnd: '❌ *Invalid Range*\n\nThe start page cannot be greater than the end page.',
    quranDaysPerWeekPrompt: '📖 *Days Per Week*\n\nYou selected pages *{startPage}* to *{endPage}* (total: *{totalPages}* pages).\n\nHow many days per week would you like to recite?\n\n*Enter a number between 1 and 7:*',
    quranInvalidDaysFormat: '❌ *Invalid Input*\n\nPlease enter a number between 1 and 7 for days per week.',
    quranInvalidDaysPerWeek: '❌ *Invalid Days*\n\nDays per week must be between 1 and 7.',
    quranScheduleTitle: '📖 *Quran Recitation Schedule*',
    quranScheduleInfo: '📋 *Schedule Details:*\n• Pages: {startPage} to {endPage}\n• Total Pages: {totalPages}\n• Days per Week: {daysPerWeek}\n• Pages per Session: ~{pagesPerSession}',
    quranScheduleDetails: 'Weekly Schedule',
    quranPagesRange: 'Pages {start}-{end} ({pages} pages)',
    quranScheduleNote: '💡 *Note:* Pages are distributed as evenly as possible. Some sessions may have slightly more or fewer pages.',
    quranNoSchedule: '❌ *No Schedule Found*\n\nYou don\'t have an active Quran recitation schedule. Please create a new schedule.',
    quranSchedulePaused: '⏸️ *Schedule Paused*\n\nYour Quran recitation schedule is currently paused.',
    quranScheduleResumed: '▶️ *Schedule Resumed*\n\nYour Quran recitation schedule has been resumed.',
    quranProgress: 'Progress',
    quranReminderEnabled: '✅ *Quran Reminder Enabled*\n\nYou will receive daily reminders for your Quran recitation schedule.',
    quranReminderDisabled: '❌ *Quran Reminder Disabled*\n\nDaily Quran reminders are now turned off.',
    quranReminderError: '❌ *Error*\n\nSorry, there was an error updating your reminder settings.',
    quranPauseError: '❌ *Error*\n\nSorry, there was an error pausing your schedule.',
    quranResumeError: '❌ *Error*\n\nSorry, there was an error resuming your schedule.',
    quranMarkCompletePrompt: '📖 *Mark Session Complete*\n\nSelect which session you completed:\n\n',
    quranInvalidSessionIndex: '❌ *Invalid Selection*\n\nPlease select a valid session number from the list.',
    quranSessionMarkedComplete: '✅ *Session Completed!*\n\n{day}: Pages {pages} marked as complete.',
    quranSessionMarkedIncomplete: '⏳ *Session Reset*\n\n{day} has been marked as incomplete.',
    btnQuranViewSchedule: '📖 View Schedule',
    btnQuranEnableReminder: '✅ Enable Reminder',
    btnQuranDisableReminder: '❌ Disable Reminder',
    btnQuranPauseSchedule: '⏸️ Pause Schedule',
    btnQuranResumeSchedule: '▶️ Resume Schedule',
    btnQuranNewSchedule: '🆕 New Schedule',
    btnQuranMarkComplete: '✅ Mark Complete'
  },
  am: {
    ...
    btnQuranScheduler: '📖 ቁርአን መርሃ ግብር',
    quranSchedulerPrompt: '📖 *ቁርአን ንባብ መርሃ ግብር*\n\nእባክዎ ለማንበብ የሚፈልጉትን የገጽ ክልል ያስገቡ።\n\n*ቅርጸት:* መጀመሪያ-መጨረሻ (ምሳሌ: 1-10) ወይም መጀመሪያ መጨረሻ (ምሳሌ: 1 10)\n\n*ምሳሌ:*\n• 1-10 (ገጾች 1 እስከ 10)\n• 50 100 (ገጾች 50 እስከ 100)\n• 1-604 (ሙሉ ቁርአን)',
    quranInvalidPageFormat: '❌ *ትክክል ያልሆነ ቅርጸት*\n\nእባክዎ የገጽ ክልሉን በእነዚህ ቅርጸቶች አንዱ ያስገቡ:\n• 1-10\n• 1 10\n• 1,10\n\n*ማስታወሻ:* ገጾች በ1 እና 604 መካከል መሆን አለባቸው።',
    quranInvalidStartPage: '❌ *ትክክል ያልሆነ የመጀመሪያ ገጽ*\n\nየመጀመሪያ ገጽ በ1 እና 604 መካከል መሆን አለበት።',
    quranInvalidEndPage: '❌ *ትክክል ያልሆነ የመጨረሻ ገጽ*\n\nየመጨረሻ ገጽ በ1 እና 604 መካከል መሆን አለበት።',
    quranStartGreaterThanEnd: '❌ *ትክክል ያልሆነ ክልል*\n\nየመጀመሪያ ገጽ ከመጨረሻ ገጽ የበለጠ ሊሆን አይችልም።',
    quranDaysPerWeekPrompt: '📖 *በሳምንት ቀናት*\n\nገጾች *{startPage}* እስከ *{endPage}* (ጠቅላላ: *{totalPages}* ገጾች) መርጠዋል።\n\nበሳምንት ስንት ቀናት ማንበብ ይፈልጋሉ?\n\n*ከ1 እስከ 7 ቁጥር ያስገቡ:*',
    quranInvalidDaysFormat: '❌ *ትክክል ያልሆነ ግቤት*\n\nእባክዎ ለበሳምንት ቀናት ከ1 እስከ 7 ቁጥር ያስገቡ።',
    quranInvalidDaysPerWeek: '❌ *ትክክል ያልሆነ ቀናት*\n\nበሳምንት ቀናት ከ1 እስከ 7 መሆን አለበት።',
    quranScheduleTitle: '📖 *ቁርአን ንባብ መርሃ ግብር*',
    quranScheduleInfo: '📋 *የመርሃ ግብር ዝርዝሮች:*\n• ገጾች: {startPage} እስከ {endPage}\n• ጠቅላላ ገጾች: {totalPages}\n• በሳምንት ቀናት: {daysPerWeek}\n• በክፍለ ጊዜ ገጾች: ~{pagesPerSession}',
    quranScheduleDetails: 'የሳምንት መርሃ ግብር',
    quranPagesRange: 'ገጾች {start}-{end} ({pages} ገጾች)',
    quranScheduleNote: '💡 *ማስታወሻ:* ገጾች በተቻለ መጠን እኩል ተከፋፍለዋል። አንዳንድ ክፍለ ጊዜዎች ትንሽ ተጨማሪ ወይም አነስተኛ ገጾች ሊኖራቸው ይችላል።',
    quranNoSchedule: '❌ *ምንም መርሃ ግብር አልተገኘም*\n\nአንድም ንቁ የቁርአን ንባብ መርሃ ግብር የሎትም። እባክዎ አዲስ መርሃ ግብር ይፍጠሩ።',
    quranSchedulePaused: '⏸️ *መርሃ ግብር ተቆምቷል*\n\nየቁርአን ንባብ መርሃ ግብርዎ በአሁኑ ጊዜ ተቆምቷል።',
    quranScheduleResumed: '▶️ *መርሃ ግብር ተገናኝቷል*\n\nየቁርአን ንባብ መርሃ ግብርዎ ተገናኝቷል።',
    quranProgress: 'እድገት',
    quranReminderEnabled: '✅ *የቁርአን ማስታወሻ ተንቃ*\n\nለቁርአን ንባብ መርሃ ግብርዎ ዕለታዊ ማስታወሻዎች ይደርሱዎታል።',
    quranReminderDisabled: '❌ *የቁርአን ማስታወሻ ተሰርዟል*\n\nዕለታዊ የቁርአን ማስታወሻዎች አሁን ተሰርዘዋል።',
    quranReminderError: '❌ *ስህተት*\n\nይቅርታ፣ የማስታወሻ ቅንብሮችዎን በማዘመን ላይ ስህተት ተከስቷል።',
    quranPauseError: '❌ *ስህተት*\n\nይቅርታ፣ መርሃ ግብርዎን በማቆም ላይ ስህተት ተከስቷል።',
    quranResumeError: '❌ *ስህተት*\n\nይቅርታ፣ መርሃ ግብርዎን በመቀጠል ላይ ስህተት ተከስቷል።',
    quranMarkCompletePrompt: '📖 *ክፍለ ጊዜ እንደተጠናቀቀ ምልክት ያድርጉ*\n\nየተጠናቀቀውን ክፍለ ጊዜ ይምረጡ:\n\n',
    quranInvalidSessionIndex: '❌ *ትክክል ያልሆነ ምርጫ*\n\nእባክዎ ከዝርዝሩ ትክክለኛ የክፍለ ጊዜ ቁጥር ይምረጡ።',
    quranSessionMarkedComplete: '✅ *ክፍለ ጊዜ ተጠናቋል!*\n\n{day}: ገጾች {pages} እንደተጠናቀቀ ምልክት ተደርጎበታል።',
    quranSessionMarkedIncomplete: '⏳ *ክፍለ ጊዜ ተመለሰ*\n\n{day} እንደማይጠናቀቅ ምልክት ተደርጎበታል።',
    btnQuranViewSchedule: '📖 መርሃ ግብር ይመልከቱ',
    btnQuranEnableReminder: '✅ ማስታወሻ አንቃ',
    btnQuranDisableReminder: '❌ ማስታወሻ አሰርዝ',
    btnQuranPauseSchedule: '⏸️ መርሃ ግብር አቁም',
    btnQuranResumeSchedule: '▶️ መርሃ ግብር ቀጥል',
    btnQuranNewSchedule: '🆕 አዲስ መርሃ ግብር',
    btnQuranMarkComplete: '✅ እንደተጠናቀቀ ምልክት ያድርጉ'
  },
  ar: {
    ...
    btnQuranScheduler: '📖 جدول القرآن',
    quranSchedulerPrompt: '📖 *جدول تلاوة القرآن*\n\nيرجى إدخال نطاق الصفحات التي تريد تلاوتها.\n\n*التنسيق:* البداية-النهاية (مثال: 1-10) أو البداية النهاية (مثال: 1 10)\n\n*مثال:*\n• 1-10 (الصفحات من 1 إلى 10)\n• 50 100 (الصفحات من 50 إلى 100)\n• 1-604 (القرآن كاملاً)',
    quranInvalidPageFormat: '❌ *تنسيق غير صحيح*\n\nيرجى إدخال نطاق الصفحات بأحد هذه التنسيقات:\n• 1-10\n• 1 10\n• 1,10\n\n*ملاحظة:* يجب أن تكون الصفحات بين 1 و 604.',
    quranInvalidStartPage: '❌ *صفحة البداية غير صحيحة*\n\nيجب أن تكون صفحة البداية بين 1 و 604.',
    quranInvalidEndPage: '❌ *صفحة النهاية غير صحيحة*\n\nيجب أن تكون صفحة النهاية بين 1 و 604.',
    quranStartGreaterThanEnd: '❌ *نطاق غير صحيح*\n\nلا يمكن أن تكون صفحة البداية أكبر من صفحة النهاية.',
    quranDaysPerWeekPrompt: '📖 *الأيام في الأسبوع*\n\nلقد اخترت الصفحات من *{startPage}* إلى *{endPage}* (المجموع: *{totalPages}* صفحة).\n\nكم يوماً في الأسبوع تريد التلاوة؟\n\n*أدخل رقماً بين 1 و 7:*',
    quranInvalidDaysFormat: '❌ *إدخال غير صحيح*\n\nيرجى إدخال رقم بين 1 و 7 للأيام في الأسبوع.',
    quranInvalidDaysPerWeek: '❌ *أيام غير صحيحة*\n\nيجب أن تكون الأيام في الأسبوع بين 1 و 7.',
    quranScheduleTitle: '📖 *جدول تلاوة القرآن*',
    quranScheduleInfo: '📋 *تفاصيل الجدول:*\n• الصفحات: {startPage} إلى {endPage}\n• إجمالي الصفحات: {totalPages}\n• الأيام في الأسبوع: {daysPerWeek}\n• الصفحات لكل جلسة: ~{pagesPerSession}',
    quranScheduleDetails: 'الجدول الأسبوعي',
    quranPagesRange: 'الصفحات {start}-{end} ({pages} صفحات)',
    quranScheduleNote: '💡 *ملاحظة:* يتم توزيع الصفحات بشكل متساوٍ قدر الإمكان. قد تحتوي بعض الجلسات على صفحات أكثر أو أقل قليلاً.',
    quranNoSchedule: '❌ *لم يتم العثور على جدول*\n\nليس لديك جدول تلاوة قرآن نشط. يرجى إنشاء جدول جديد.',
    quranSchedulePaused: '⏸️ *تم إيقاف الجدول*\n\nجدول تلاوة القرآن الخاص بك متوقف حالياً.',
    quranScheduleResumed: '▶️ *تم استئناف الجدول*\n\nتم استئناف جدول تلاوة القرآن الخاص بك.',
    quranProgress: 'التقدم',
    quranReminderEnabled: '✅ *تم تفعيل تذكير القرآن*\n\nستتلقى تذكيرات يومية لجدول تلاوة القرآن الخاص بك.',
    quranReminderDisabled: '❌ *تم إلغاء تذكير القرآن*\n\nتم إيقاف تذكيرات القرآن اليومية.',
    quranReminderError: '❌ *خطأ*\n\nعذراً، حدث خطأ في تحديث إعدادات التذكير.',
    quranPauseError: '❌ *خطأ*\n\nعذراً، حدث خطأ في إيقاف الجدول.',
    quranResumeError: '❌ *خطأ*\n\nعذراً، حدث خطأ في استئناف الجدول.',
    quranMarkCompletePrompt: '📖 *تحديد الجلسة كمكتملة*\n\nاختر الجلسة التي أكملتها:\n\n',
    quranInvalidSessionIndex: '❌ *اختيار غير صحيح*\n\nيرجى اختيار رقم جلسة صحيح من القائمة.',
    quranSessionMarkedComplete: '✅ *تم إكمال الجلسة!*\n\n{day}: تم تحديد الصفحات {pages} كمكتملة.',
    quranSessionMarkedIncomplete: '⏳ *تم إعادة تعيين الجلسة*\n\nتم تحديد {day} على أنه غير مكتمل.',
    btnQuranViewSchedule: '📖 عرض الجدول',
    btnQuranEnableReminder: '✅ تفعيل التذكير',
    btnQuranDisableReminder: '❌ إلغاء التذكير',
    btnQuranPauseSchedule: '⏸️ إيقاف الجدول',
    btnQuranResumeSchedule: '▶️ استئناف الجدول',
    btnQuranNewSchedule: '🆕 جدول جديد',
    btnQuranMarkComplete: '✅ تحديد كمكتمل'
  }
};
